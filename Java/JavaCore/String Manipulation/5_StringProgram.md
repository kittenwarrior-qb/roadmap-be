...
## 4. How to remove all occurrences of a given character from input String?
...
## 5. How to prove String is immutable programatically?
...
## 6. Write a program to count number of words in a String?
...
## 7. Write a program to check if two Strings are created with same characters?
...
## 8. Read two String user input and check if first contains second?
...
## 9. How to swap two Strings without using a third variable?
...
## 10. Write a program to find out first non repeated character from input String?
...
## 11. Provide two ways to check if a String contains only digits?
